...
This repository contains the package with generic utils functionality.
...
In order to install and use the linked dependencies for `pkg-utils` the following command can be used:
